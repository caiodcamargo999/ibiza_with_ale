...
import { ArrowRightIcon, ChatBubbleIcon, ActivityLogIcon, SewingPinIcon, SunIcon, StarIcon, ClockIcon } from "@radix-ui/react-icons";
...
const beaches = [
  {
    ...
    image: "/images/beaches_ibiza/cala_comte_ibiza_.jpg",
  ...
  },
  {
    ...
    image: "/images/beaches_ibiza/ses_salines.jpg",
  ...
  },
  {
    ...
    image: "/images/beaches_ibiza/cala_bassa_beach_ibiza.webp",
  ...
  },
  {
    ...
    image: "/images/beaches_ibiza/cala_dhort_ibiza.jpg",
  ...
  },
  {
    ...
    image: "/images/beaches_ibiza/cala_salada.jpg",
  ...
  },
  {
    ...
    image: "/images/beaches_ibiza/cala_benirras.jpg",
  ...
  },
  {
    ...
    image: "/images/beaches_ibiza/talamanca.jpg",
  ...
  },
  {
    ...
    image: "/images/beaches_ibiza/cala_jondal.jpg",
      ...
      <section className="relative pt-24 pb-12 md:py-32 overflow-hidden">
        <div className="absolute inset-0">
          <Image fill sizes="100vw"
            src="/images/beaches_ibiza/hero.webp"
        ...
        <div className="container relative z-10">
          <AnimatedSection>
            <p className="text-sm font-medium text-primary uppercase tracking-widest mb-4">Guida spiagge 2026</p>
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-display font-black leading-[0.9] mb-6">
              Le spiagge più belle
              <br />
              <span className="text-primary">di Ibiza</span>
            </h1>
                  ...
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="flex-1 p-6 lg:p-8">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <div className="flex items-center gap-3 text-xs text-muted-foreground/60">
                            <span className="flex items-center gap-1"><SewingPinIcon className="w-3 h-3" /> {beach.zone}</span>
                            <span className="flex items-center gap-1"><ActivityLogIcon className="w-3 h-3" /> {beach.type}</span>
                          </div>
                        </div>
                      ...
                      <div className="grid sm:grid-cols-3 gap-4 mb-5">
                        ...
                        <div className="bg-muted/20 rounded-xl p-3">
                          <div className="flex items-center gap-1.5 mb-1">
                            <SunIcon className="w-3 h-3 text-sunset-gold" />
                      ...
                      <div className="space-y-1.5">
                        {beach.tips.map((tip, j) => (
                          <p key={j} className="text-xs text-muted-foreground/80 flex gap-2">
                            <SunIcon className="w-3 h-3 text-primary mt-0.5 flex-shrink-0" />
                            {tip}
                          </p>
                        ))}
                      </div>
                      ...
                      <div className="mt-4 pt-4 border-t border-border/20">
                        <p className="text-xs text-muted-foreground/60">
                          <span className="text-primary">Ideale per:</span> {beach.bestFor}
                        </p>
                      </div>
                    </div>
                  </div>
