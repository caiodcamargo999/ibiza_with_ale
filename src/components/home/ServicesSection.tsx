...
import { ArrowRightIcon, ReaderIcon, HomeIcon, LightningBoltIcon, GlobeIcon, SpeakerLoudIcon, HeartIcon } from "@radix-ui/react-icons";
      ...
      <div className="container relative z-10">
        <AnimatedSection>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-4">
            ...
            <br />
            <span className="text-primary">per il tuo viaggio</span>
          </h2>
