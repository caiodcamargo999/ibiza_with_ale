    ...
    <section className="py-24 bg-dark-section relative overflow-hidden">
      ...
      <div className="container max-w-5xl relative z-10">
        <AnimatedSection className="text-center mb-16">
          <p className="text-sm font-semibold uppercase tracking-widest text-sunset-orange mb-3">Living Ibiza</p>
          <h2 className="text-3xl md:text-5xl font-display font-black leading-tight">
            Esperienza Reale, <span className="text-gradient-warm">Connessioni Locali</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <AnimatedSection delay={0.1}>
            <div className="group relative rounded-[2rem] border border-white/5 bg-[#0B0C0E] overflow-hidden shadow-2xl p-2 transition-all duration-500 hover:shadow-[0_0_30px_rgba(249,115,22,0.15)] hover:border-white/10">
              ...
              <div className="relative aspect-[4/5] rounded-[1.7rem] overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-6 rounded-2xl bg-[#0B0C0E]/80 backdrop-blur-md border border-white/5 transition-colors duration-300 group-hover:bg-[#121316]/95">
                  <span className="text-xs font-bold uppercase tracking-wider text-sunset-orange">Nightlife & Clubbing</span>
